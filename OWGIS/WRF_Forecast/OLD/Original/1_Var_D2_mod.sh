#!/bin/sh
 ...
 ###ncks -v Times,T2,RAINNC,RAINC,U,V,U10,V10,SST,P,PB,SLP,XLAT,XLONG $NOMBRE2 pronostico.nc
    ncks -v Times,T2,RAINNC,RAINC,U,V,U10,V10,SST,P,PB,XLAT,XLONG,SLP $NOMBRE2 pronostico.nc
 ...
 ###ncks -v Times,PREC2,WS10,PA,T2C,SSTC,XLAT,XLONG,U,V,U10,V10,PREC2B,P,PB  pronostico_7.nc pronostico_pf2.nc
    ncks -v Times,PREC2B,SSTC,T2C,PT,PREC2,PA,WS10,XLAT,XLONG,U,V,U10,V10,P,PB,SLP  pronostico_7.nc pronostico_pf2.nc
